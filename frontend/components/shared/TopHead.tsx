...
const TopHead = () => {
    ...
    return (
        <>
            <Row className="mt-3">
                ...
                <Col xs={6} md={4}>
                    ...
                    <InputGroup>
                        ...
                        />
                        <Button variant="outline-success" id="button-addon2" onClick={() => search()}>
                            Search
                        </Button>
                    </InputGroup>
                </Col>
            ...
            <Navbar collapseOnSelect expand="lg" bg="light" variant="light" color="#4c575f">
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Nav>
                        <Nav.Link className={styles.cartItems} onClick={() => setShow(true)}>
