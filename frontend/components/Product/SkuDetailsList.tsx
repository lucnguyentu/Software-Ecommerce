...
const SkuDetailsList: FC<ISkuDetailsListProps> = ({ skuDetails: allSkuDetails, productId, setAllSkuDetails }) => {
                                ...
                                allSkuDetails.map((skuDetail: any, key: any) => (
                                    <tr key={key}>
                                        ...
                                        <td>
                                            ...
                                            <Button variant="outline-dark" onClick={() => deleteHandler(skuDetail._id)}>
