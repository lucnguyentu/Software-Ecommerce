...
const SkuDetailsForm: FC<ISkuDetailsFormProps> = ({
    ...
    useEffect(() => {
        if (skuIdForUpdate) {
            const sku = allSkuDetails.find((sku: { _id: string }) => sku._id === skuIdForUpdate);
            ...
            <Form>
                <Form.Group controlId="formBasicEmail">
                    ...
                    <Form.Control
                        ...
                        onChange={(e) => setSkuFrom({ ...skuForm, skuName: e.target.value })}
                    />
                </Form.Group>
                <Form.Group controlId="formBasicPassword">
                    ...
                    <Form.Control
                        ...
                        value={skuForm.price}
                        onChange={(e) => setSkuFrom({ ...skuForm, price: parseFloat(e.target.value) })}
                    />
                </Form.Group>
                <Form.Group controlId="formBasicPassword">
                    ...
                    <InputGroup className="mb-3">
                        <Form.Control
                            ...
                            onChange={(e) => setSkuFrom({ ...skuForm, validity: parseInt(e.target.value) })}
                        />
                        <DropdownButton
                ...
                <div style={{ marginTop: '10px' }}>
                    ...
                    <Button variant="outline-primary" type="submit" onClick={handleSubmit} disabled={isLoading}>
                        {isLoading && (
