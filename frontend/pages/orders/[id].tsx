        ...
        <>
            ...
            <Row>
                <Col>
                    <Card style={{ marginTop: '20px' }}>
                        <Card.Header>
                            <Card.Title>Total Amout : {order.paymentInfo?.paymentAmount} vnđ</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            <ListGroup className="list-group-flush">
                                <ListGroup.Item>Order Date & Time: 20th Sep, 2022, 06:26PM</ListGroup.Item>
                                <ListGroup.Item>
                                    Paymnet Method: {order.paymentInfo?.paymentMethod.toUpperCase()}
                                </ListGroup.Item>
                                <ListGroup.Item>
...
export const getServerSideProps: GetServerSideProps<OrderProps> = async (context): Promise<any> => {
    try {
